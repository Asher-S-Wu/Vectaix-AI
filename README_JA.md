...
5つの直接チャットモデルとFusion Modeに、統一インターフェースでアクセス。会話中にモデルを切り替えても、コンテキストは完全に保持されます。
...
| **Gemini 3.5 Flash** | Google | 1M | テキスト、画像、音声、動画 | ✅ | ✅ |
| **Grok 4.5** | xAI | 500K | テキスト、画像 | ✅ | ✅ |
| **GLM-5.2** | Z.AI | 1M | テキスト、画像 | ✅ | ✅ |
...
1. **並列生成** — クエリは GPT-5.6 Sol、Claude Opus 4.8、Gemini 3.5 Flash に同時送信
...
| `AIHUBMIX_API_KEY` | — | GPT、Grok、Claude、GLM、画像、動画用のInferera APIキー |
