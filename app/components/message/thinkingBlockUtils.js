...
export function normalizeTimeline(timeline) {
  ...
  const normalized = timeline
    ...
    .filter((step) => step.kind === "thought" || step.kind === "search" || step.kind === "reader" || step.kind === "tool" || step.kind === "planner" || step.kind === "writer" || step.kind === "image_gen" || step.kind === "video_gen");
