...
const sections = [
  ...
  ['usage', '用量与日志', ChartNoAxesCombined, '查看花费、执行记录和存储占用'],
  ['users', '用户管理', Users, '管理用户账号', true],
];
const panels = { general: GeneralPanel, assistant: AssistantPanel, skills: SkillsPanel, memory: MemoryPanel, connections: ConnectionsPanel, browser: BrowserPanel, files: FilesPanel, backups: BackupsPanel, permissions: PermissionsPanel, usage: UsagePanel, users:UsersPanel };
