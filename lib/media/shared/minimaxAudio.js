export const MINIMAX_AUDIO_MODELS = Object.freeze([
  Object.freeze({ id: "MiniMax/speech-2.8-hd", label: "Speech 2.8 HD" }),
  Object.freeze({ id: "MiniMax/speech-2.8-turbo", label: "Speech 2.8 Turbo" }),
]);
...
export const MINIMAX_VOICE_UNLOCK_PRICE_CNY = 9.9;
...
export const MINIMAX_AUDIO_MAX_SAMPLE_RATE = 44_100;
export const MINIMAX_AUDIO_DEFAULT_SAMPLE_RATE = MINIMAX_AUDIO_MAX_SAMPLE_RATE;
