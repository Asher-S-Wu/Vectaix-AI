...
export const IMAGE_SIZE_OPTIONS = Object.freeze([
  ...
  Object.freeze({ id: "1024x1024", label: "正方形 1024×1024" }),
  Object.freeze({ id: "1536x1024", label: "横版 1536×1024" }),
  Object.freeze({ id: "1024x1536", label: "竖版 1024×1536" }),
]);

const MICU_IMAGE_SIZES = Object.freeze([
  Object.freeze({ id: "1024x1024", label: "正方形 1024×1024" }),
  Object.freeze({ id: "1280x720", label: "横版 1280×720" }),
  Object.freeze({ id: "720x1280", label: "竖版 720×1280" }),
  Object.freeze({ id: "1024x1536", label: "竖版 1024×1536" }),
  Object.freeze({ id: "1536x1024", label: "横版 1536×1024" }),
  Object.freeze({ id: "2048x2048", label: "正方形 2048×2048" }),
  Object.freeze({ id: "2048x1152", label: "横版 2048×1152" }),
  Object.freeze({ id: "1152x2048", label: "竖版 1152×2048" }),
  Object.freeze({ id: "3840x2160", label: "4K 横版 3840×2160（实验性）" }),
  Object.freeze({ id: "2160x3840", label: "4K 竖版 2160×3840（实验性）" }),
]);
const MICU_IMAGE_QUALITIES = Object.freeze([
  Object.freeze({ id: "auto", label: "自动" }),
  Object.freeze({ id: "low", label: "低" }),
  Object.freeze({ id: "medium", label: "中" }),
  Object.freeze({ id: "high", label: "高" }),
  Object.freeze({ id: "xhigh", label: "超高" }),
  Object.freeze({ id: "max", label: "最高" }),
]);
const MICU_IMAGE_OPTIONS = Object.freeze({
  service: "micu",
  sizes: MICU_IMAGE_SIZES,
  qualities: MICU_IMAGE_QUALITIES,
...
export function validateImageOptions({ model, size, quality } = {}) {
  ...
  if (!config.qualities.some((option) => option.id === quality)) {
    throw imageValidationError(`${config.name} 不支持所选画质，请重新选择`);
  }
