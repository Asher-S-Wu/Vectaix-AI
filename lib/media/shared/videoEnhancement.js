...
export const VIDEO_ENHANCEMENT_MODEL_NAME = "AI Video Enhancement";
...
export function normalizeVideoEnhancementCreateInput(value) {
  ...
  assertOnlyKeys(value, ["source", "resolution", "fps", "bitrate", "sourceDurationSeconds"], "视频画质增强参数");
  ...
  if (Object.hasOwn(value, "sourceDurationSeconds")) {
    normalized.sourceDurationSeconds = normalizeInteger(value.sourceDurationSeconds, "视频时长", 1, 60);
  }
