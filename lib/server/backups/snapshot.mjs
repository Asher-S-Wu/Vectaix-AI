...
export function safeMediaSettings(value) {
  const result = {};
  const groups = { image: ['model','size','quality','count'], audio: ['provider','voiceId','format','sampleRate','instruction','rate','pitch','volume','languageHint','model','emotion','languageBoost','speed','speechRate','loudnessRate','pitchRate'], enhancement: ['resolution'] };
