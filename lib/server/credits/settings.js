...
function validateChatRates(chat) {
  ...
  for (const modelId of Object.keys(defaultChat)) {
    const extraKeys = modelId === "gpt-6-astra"
  ...
  assertFiniteNonNegative(chat["gpt-6-astra"].cachedInputPerMillion, "rates.chat.gpt-6-astra.cachedInputPerMillion");
  assertFiniteNonNegative(chat["gpt-6-astra"].cacheWritePerMillion, "rates.chat.gpt-6-astra.cacheWritePerMillion");
  assertNonNegativeInteger(chat["gpt-6-astra"].longContextThreshold, "rates.chat.gpt-6-astra.longContextThreshold");
  assertFinitePositive(chat["gpt-6-astra"].longInputMultiplier, "rates.chat.gpt-6-astra.longInputMultiplier");
  assertFinitePositive(chat["gpt-6-astra"].longOutputMultiplier, "rates.chat.gpt-6-astra.longOutputMultiplier");
  assertFiniteNonNegative(chat["qwen-3.8-max-0902"].cachedInputPerMillion, "rates.chat.qwen-3.8-max-0902.cachedInputPerMillion");
