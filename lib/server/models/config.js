...
export const MODEL_PROVIDERS = {
  ...
  'micu-claude-opus-5-5': { id:'micu-claude-opus-5-5', protocol:'anthropic', baseUrl:`${MICU_BASE_URL}/v1`, keyEnv:'MICU_ANTHROPIC_API_KEY', headers:{'User-Agent':CLAUDE_USER_AGENT} },
...
const definitions = [
  ...
  ['claude-opus-5-5','Claude Opus 5.5','anthropic','micu-claude-opus-5-5','claude-opus-5-5',1000000,128000,{thinking:{type:'adaptive',display:'summarized'},output_config:{effort:'max'},cache_control:{type:'ephemeral'}}],
