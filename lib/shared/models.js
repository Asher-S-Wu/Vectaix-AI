export const CLAUDE_OPUS_MODEL = "anthropic/claude-opus-4.7";
...
export const OPENAI_PRIMARY_MODEL = "openai/gpt-5.5";
export const QWEN_MODEL_ID = "qwen/qwen3.6-max-preview";
...
export const MODEL_GROUP_ORDER = ["gemini", "claude", "openai", "moonshot", "qwen", "seed", "deepseek"];
...
export function getCouncilExpertDisplayLabel(expert) {
  ...
  if (/kimi|moonshot/i.test(rawLabel)) return "Kimi";
...
export function getDefaultMaxTokensForModel(modelId) {
  ...
  if (normalized === KIMI_K2_6_MODEL) {
    return 65536;
  }
  if (normalized === QWEN_MODEL_ID || normalized === DEEPSEEK_V4_PRO_MODEL) {
    return 64000;
  }
  return 64000;
}
